...
export function UpNextHero({ video, classId }: UpNextHeroProps) {
  if (!video) {
    return (
      <Card className="w-full relative overflow-hidden border-2 border-dashed border-border bg-card/50 py-0 xl:py-6">
        <div className="p-4 sm:p-6 md:p-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <div className="flex min-w-0 items-start gap-4 sm:gap-5">
            <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-emerald-500/10 flex items-center justify-center shrink-0">
            ...
            <div className="min-w-0">
              ...
              <h2 className="text-xl sm:text-2xl font-bold mb-2">No active lessons remaining</h2>
  ...
  return (
    <Card className="w-full relative overflow-hidden border-2 border-primary/20 bg-card shadow-lg py-0 xl:py-6">
